...
public class DataBindingUtils {
    ...
    public static Collection<Ref< ? >> getInputBindings(final Context context, final Function f) throws DataBindingException  {
        ...
        for (Ref< ? > ref : dataBindings) {
            logger.debug(" - {}", ref);
        }
        return dataBindings;
    }

    public static Collection<Ref< ? >> getOutputBindings(final Context context, final Function f) throws DataBindingException {
        ...
        for (Ref< ? > dataRef : dataBindings) {
            logger.debug(" - {}", dataRef);
        }
        return dataBindings;
    }

    public static Collection<Ref<?>> getDataBindings(Function f, Class<? extends Annotation> bindingAnnotationClass, Class<?> implementationClass) {
