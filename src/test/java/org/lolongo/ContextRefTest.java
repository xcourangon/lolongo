...
public class ContextRefTest {
    ...
    public void testNullContextRef() throws Exception {
        ContextRef.getContext(new ContextNode("root"), null);
    }
    ...
    public void testIsParent() throws Exception {
        ...
        Assert.assertFalse(ContextRef.isParent(root, root));
        Assert.assertFalse(ContextRef.isParent(subcontext1, subcontext1));
        Assert.assertFalse(ContextRef.isParent(subsubcontext11, subsubcontext11));

        Assert.assertTrue(ContextRef.isParent(root, subcontext1));
        Assert.assertTrue(ContextRef.isParent(root, subsubcontext11));
        Assert.assertTrue(ContextRef.isParent(root, subsubcontext12));
        Assert.assertTrue(ContextRef.isParent(root, subcontext2));
        Assert.assertTrue(ContextRef.isParent(root, subsubcontext21));
        Assert.assertTrue(ContextRef.isParent(root, subsubcontext22));

        Assert.assertFalse(ContextRef.isParent(subcontext1,root));
        Assert.assertTrue(ContextRef.isParent(subcontext1, subsubcontext11));
        Assert.assertTrue(ContextRef.isParent(subcontext1, subsubcontext12));
        Assert.assertFalse(ContextRef.isParent(subcontext1, subcontext2));
        Assert.assertFalse(ContextRef.isParent(subcontext1, subsubcontext21));
        Assert.assertFalse(ContextRef.isParent(subcontext1, subsubcontext22));

        Assert.assertFalse(ContextRef.isParent(subcontext2,root));
        Assert.assertFalse(ContextRef.isParent(subcontext2, subsubcontext11));
        Assert.assertFalse(ContextRef.isParent(subcontext2, subsubcontext12));
        Assert.assertFalse(ContextRef.isParent(subcontext2, subcontext1));
        Assert.assertTrue(ContextRef.isParent(subcontext2, subsubcontext21));
        Assert.assertTrue(ContextRef.isParent(subcontext2, subsubcontext22));

        Assert.assertFalse(ContextRef.isParent(subsubcontext11, subsubcontext12));
        Assert.assertFalse(ContextRef.isParent(subsubcontext12, subsubcontext11));
        Assert.assertFalse(ContextRef.isParent(subsubcontext21, subsubcontext22));
        Assert.assertFalse(ContextRef.isParent(subsubcontext22, subsubcontext21));
}
}
