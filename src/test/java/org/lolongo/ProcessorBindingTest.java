...
public class ProcessorBindingTest {
	...
	final Collection<Function>[] sortedFunctions = ProcessorBinding.sort(functions, context);
	...
	final Collection<Function> functions = new ArrayList<>();
	final CompositeFunction function = new ToUpperAndQuote2(new RefId<String>("in"), new RefId<String>("out"));
	...
	final Collection<Function> functions = new ArrayList<>();
	final Addition add1 = new Addition(new RefId<Double>("a"), new RefId<Double>("b"), new RefId<Double>("d"));
	functions.add(add1);
